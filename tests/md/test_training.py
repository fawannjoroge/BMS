...
from scripts.training import (
    set_random_seeds, configure_gpu, load_and_preprocess_data,
...
class TestTraining(unittest.TestCase):
    ...
    def test_load_and_preprocess_data_file_not_found(self, mock_load, mock_exists):
        mock_exists.return_value = False
        with self.assertRaises(FileNotFoundError):
            load_and_preprocess_data(self.test_config)
    ...
    def test_build_model(self, mock_create_model):
        ...
        mock_create_model.assert_called_once_with(
            ...
            bidirectional=self.test_config['bidirectional'],
            use_batchnorm=self.test_config['use_batchnorm'],
    ...
    def test_save_model(self, mock_join):
        mock_model = MagicMock()
        mock_join.return_value = 'test/path/final_model.h5'
        save_model(mock_model)
        mock_model.save.assert_called_once_with('test/path/final_model.h5')
